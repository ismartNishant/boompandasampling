      ...
      <div className="flex flex-col gap-5 py-8 md:py-16 text-sm md:text-lg">
        ...
        <div className="flex flex-col gap-4">
          <p>
            ...
            gigs, micro-jobs, part time jobs, avail discounts & offers, register
            for activities, applying for internships.
          </p>
          <p>
          ...
          <p>
            ...
            and/or are in any manner connected with and/or contribute to the use
            of the Platform (&quot;User&quot;, &quot;you&quot; or
            &quot;your&quot;) and this Website operator (&quot;Operator&quot;,
            &quot;we&quot;, &quot;us&quot; or &quot;our&quot;). Subject to Your
            compliance with these Terms, We grant You a non-exclusive,
            non-transferable, limited privilege to access and use Our Platform.
            ...
            These Terms are an electronic record generated by a computer system
        ...
        <div className="flex flex-col gap-4">
          ...
          <p>
            ...
            Agreement you warrant and represent that you are at least 13 years
            ...
            re-register for our Services and we may, in its sole discretion and
        ...
        <div className="flex flex-col gap-4">
          ...
          <p>
            ...
            or parents who have given their implied consent to allow their minor
            dependents to use this Platform(s), at the risks and consequences of
          ...
          <p>
            ...
            any personal information on the Platform(s).
          </p>
        </div>
        <div className="flex flex-col gap-4">
          <h1 className=" text-xl md:text-2xl text-primary font-semibold tracking-wider">
          ...
          <p>
            ...
            <span className="font-semibold text-primary tracking-wider">
              {" "}
              You acknowledge that such Activities are subject to the terms and
            ...
            have posted and Your use of the Services.
          </p>
        </div>
        <div className="flex flex-col gap-4">
          <h1 className=" text-xl md:text-2xl text-primary font-semibold tracking-wider">
        ...
        <div className="flex flex-col gap-4">
          ...
          <p>
            ...
            or right to use of all submitted Content. We may, but have no
        ...
        <div className="flex flex-col gap-4">
          ...
          <p>
            ...
            pass that Reward/Cashback to the Member to his/her Wallet which can
            be then withdrawn through various methods.
          </p>
          <p>
            ...
            us, but with the individual Brand/Retailer. Our support team provide
            further information about these circumstances. Further, from time to
            time Brands/Retailers may increase or decrease the commission paid –
            in which case the cashback offer illustrated on our Platform may be
            incorrect. By default, your applicable transactions will be credited
            in line with the commission reported to us by the Brand/Retailer,
            which may be more or less than the advertised rate. We shall not be
            liable for any difference in the expected cashback by the Member and
            the actual Cashback received by the Member.
          </p>
          <p>
            When we have traced a paying, Qualifying Transaction to your
            Account, we will credit your Account with a &apos;pending
            payment&apos;. Once the Retailer confirms the transaction, the
            payment will be marked as &apos;validated&apos; – this can take 90
          ...
          <p>
            ...
            Qualifying Transaction. Further, we shall not be responsible in the
            event due to some technical or other error we cannot trace an
            Activity back to the Member and does not qualify the transaction as
            a Qualifying Transaction for any reason whatsoever. Whilst we will
            endeavour to recuperate non-payments from the Brand/Retailer, the
            decision of ourselves, the Retailer or Retailer&apos;s tracking
            agent is final. Whilst we will try and recuperate missing
            commissions, at any point we reserve the right not to chase missing
            commission claims, particularly where no activity has been
            performed.
          </p>
          <p>
          ...
          <p>
            ...
            would check if the user had an exit click from our Platform for that
            store on the date mentioned by the user. If no exit clicks can be
            tracked, then we will show a message to the Member indicating that
            they did not click via our website to earn cashback prior to the
            sale. All exit clicks to stores are saved in the database for cross
            reference on adding cashback values. Where a commission enquiry has
            been successfully paid by a Brand/Retailer, you may receive a lower
            amount than expected; this is due to the amounts received by
            ourselves possibly being lower than the original claim. We do allow
            you to query this with us. If a Brand/Retailer still hasn&apos;t
          ...
          <p>
            ...
            any credited transaction has not been received from a Brand/Retailer
          ...
          <p>
            There are various circumstances in which Reward/Cashback will not be
            payable to the Member, and will be forfeited to us, these could be,
            without limitation:
          </p>
          <p>
            ...
            the Member is not logged-in to our Platform when making the relevant
            activity/purchase)
          </p>
          <p>
            the transaction to which the Cashback relates is cancelled after it
            has been entered into (whether under the right of cancellation that
            applies to some activities made at a distance, or otherwise) the
            Reward/Cashback is attributed to a Member or Account that has been:
            suspended by us for any reason; associated with any fraudulent
            activity or any breach of this Agreement.
          </p>
        </div>
        <div className="flex flex-col gap-4">
          <h1 className=" text-xl md:text-2xl text-primary font-semibold tracking-wider">
        ...
        <div className="flex flex-col gap-4">
          ...
          <p>
            ...
            access through a link on the Website and Services. Your linking to
            any other off-site resources is at your own risk.
          </p>
        </div>
        <div className="flex flex-col gap-4">
          <h1 className=" text-xl md:text-2xl text-primary font-semibold tracking-wider">
        ...
        <div className="flex flex-col gap-4">
          ...
          <p>
            ...
            rights conferred by statute, common law or equity in or in relation
            to any copyright and related rights, trademarks, designs, patents,
        ...
        <div className="flex flex-col gap-4">
          ...
          <p>
            ...
            information You have provided to Us and Your use of the Platform. By
            applying to any Activities, you consent to receiving communication
            regarding the that Activity or further Activities. We may use
        ...
        <div className="flex flex-col gap-4">
          ...
          <p>
            ...
            Maharashtra, India, and you hereby submit to the personal
        ...
        <div className="flex flex-col gap-4">
          ...
          <p>
            ...
            will revise the updated date on this page. Continued use of the
        ...
        <div className="flex flex-col gap-4">
          ...
          <p>
            ...
            been wrongfully accused, he is encouraged to reach out to Us
          </p>
        </div>
        <div className="flex flex-col gap-4">
          <h1 className=" text-xl md:text-2xl text-primary font-semibold tracking-wider">
          ...
          <p>
            ...
            provide feedback regarding the Platform, in the form of Text, Image
            or Video and in such circumstances, any feedback You provide will be
            deemed non-confidential and We shall have the right, but not the
            obligation, to use such feedback on an unrestricted basis.
          </p>
        </div>
        <div className="flex flex-col gap-4">
          <h1 className=" text-xl md:text-2xl text-primary font-semibold tracking-wider">
